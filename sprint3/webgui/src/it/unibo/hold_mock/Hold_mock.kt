		...
		return { //this:ActionBasciFsm
				...
				state("wait_request") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t02",targetState="check_reservation",cond=whenRequest("reserve_slot"))
					transition(edgeName="t03",targetState="serving_get_hold_state",cond=whenRequest("get_hold_state"))
				}	 
				...
				state("serving_get_hold_state") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("get_hold_state(X)"), Term.createTerm("get_hold_state(X)"), 
								...
								CommUtils.outyellow("$name | DEBUG wrapped = $JsonState")
