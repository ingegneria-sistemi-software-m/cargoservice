...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     with Cluster('ctx_iodevices', graph_attr=nodeattr):
          ...
          sonarlistener=Custom('sonarlistener','./qakicons/symActorWithobjSmall.png')
     sonarsimul >> Edge( label='measurement', **eventedgeattr, decorate='true', fontcolor='red') >> sonarlistener
diag
