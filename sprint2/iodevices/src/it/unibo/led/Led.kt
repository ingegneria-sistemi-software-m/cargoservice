		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition( edgeName="goto",targetState="spento", cond=doswitch() )
				}	 
				state("spento") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t01",targetState="acceso",cond=whenEvent("interrompi_tutto"))
				}	 
				state("acceso") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t02",targetState="spento",cond=whenEvent("riprendi_tutto"))
				}	 
			}
		}
} 
